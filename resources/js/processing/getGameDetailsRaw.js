...
for (var i = startOfRegSeason; i < 4390; i++) {
    unirest.get("https://api-nba-v1.p.rapidapi.com/gameDetails/" + i)
        ...
        .end(function(result) {
            ...
            fs.appendFile("/Library/WebServer/Documents/topfivin/resources/data/gameDetailsRaw.json", JSON.stringify(result) + ",", function(err) {
                if (err) {
